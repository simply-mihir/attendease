    ...
    <div className="flex min-h-screen flex-col relative z-0">
      ...
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b-2 border-gray-200 bg-white/80 backdrop-blur-sm px-4 sm:px-6 dark:border-[#2a2a3d] dark:bg-[#0a0e1a]/80 shrink-0">
        <div className="flex items-center gap-3 sm:gap-4">
          <button onClick={() => setSidebarOpen(true)} className="text-[#4a4a5a] hover:text-[#1a1a2e] dark:text-[#6b6b80] dark:hover:text-white transition lg:hidden shrink-0">
          ...
          <Link href="/dashboard" className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-black tracking-tight text-[#FF2D78] hidden sm:block">AttendEase</span>
          </Link>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 top-16 z-30 bg-black/50 backdrop-blur-sm lg:hidden" onClick={() => setSidebarOpen(false)} />
        )}
