...
export default function ForecastPage() {
  ...
  return (
    <PageTransition direction="left" staggerChildren={false} className="max-w-4xl mx-auto space-y-6">
      {/* Header */}
      ...
      {/* Summary card */}
      <div className="glass rounded-2xl p-5 flex items-center gap-4" style={{ opacity: 0, animation: "fadeSlideUp 0.5s ease-out 50ms forwards" }}>
        <div
          className={clsx(
