    ...
    <main className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        >
          ...
          <button onClick={() => signIn("google", { callbackUrl: "/dashboard" })} className="w-full py-3 mb-4 btn-3d-secondary rounded-xl text-sm font-bold flex items-center justify-center gap-3 transition">
          ...
          <button onClick={() => signIn("github", { callbackUrl: "/dashboard" })} className="w-full py-3 bg-[#24292e] hover:bg-[#2f363d] active:translate-y-[2px] active:shadow-[0_0_0_0_#1b1f23] border-2 border-[#1b1f23] text-white rounded-xl text-sm font-bold flex items-center justify-center gap-3 transition shadow-[0_4px_0_0_#1b1f23]">
