        ...
        >
          ...
          <div className="flex gap-4 w-full mb-6">
            <button onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
              className="flex-1 py-3 btn-3d-secondary rounded-xl text-sm flex items-center justify-center gap-2 font-bold transition">
            ...
            <button onClick={() => signIn("github", { callbackUrl: "/dashboard" })}
              className="flex-1 py-3 bg-[#24292e] hover:bg-[#2f363d] active:translate-y-[2px] active:shadow-[0_0_0_0_#1b1f23] border-2 border-[#1b1f23] text-white rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition shadow-[0_4px_0_0_#1b1f23]">
