          ...
          if (currentExam) {
            ...
            return (
              <div className="space-y-4 mb-6" style={{ opacity: 0, animation: "fadeSlideUp 0.5s ease-out 100ms forwards" }}>
                ...
                <div className="rounded-2xl p-8 bg-[#0ea5e9]/[0.06] border-2 border-[#0ea5e9]/40 shadow-[0_6px_0_0_#0ea5e9] dark:bg-[#0ea5e9]/[0.08] dark:border-[#0ea5e9]/40 dark:shadow-[0_6px_0_0_#0284c7] text-center relative overflow-hidden animate-unique-card">
                  ...
                  <div className="inline-block relative z-10 px-8 py-5 mt-2 rounded-[2.5rem] bg-[#e0f2fe] dark:bg-[#0c4a6e] shadow-[8px_8px_16px_rgba(14,165,233,0.15),inset_4px_4px_8px_rgba(255,255,255,0.8),inset_-4px_-4px_8px_rgba(14,165,233,0.2)] dark:shadow-[8px_8px_16px_rgba(0,0,0,0.3),inset_4px_4px_8px_rgba(255,255,255,0.05),inset_-4px_-4px_8px_rgba(0,0,0,0.4)] transition-transform">
                    <h3 className="text-xl font-black mb-1 drop-shadow-sm animate-unique-text">
                      No classes. {examName} are going on.
                    </h3>
                    <br />
                    <p className="font-bold text-sm drop-shadow-sm animate-unique-text">
